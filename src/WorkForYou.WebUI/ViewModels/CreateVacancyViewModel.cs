...
public class CreateVacancyViewModel
{
    ...
    [StringLength(250, MinimumLength = 50,
        ErrorMessage = "Довжина короткого опису має бути в діапазоні від 50 до 250 символів")]
    public string ShortDescription { get; set; } = string.Empty;

    [Required(ErrorMessage = "LongDescription поле має бути заповненим")]
    [Display(Name = "Детальний опис")]
    [StringLength(5000, MinimumLength = 200,
        ErrorMessage = "Довжина детального опису має бути в діапазоні від 200 до 5000 символів")]
